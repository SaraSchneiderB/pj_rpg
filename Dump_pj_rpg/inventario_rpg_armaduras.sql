...
CREATE TABLE `armaduras` (
  ...
  `classe_armadura` varchar(30) DEFAULT NULL,
  `peso` varchar(5) DEFAULT NULL,
  `valor` varchar(10) DEFAULT NULL,
  `forca` int DEFAULT NULL,
  `furtividade` char(11) DEFAULT NULL,
...
INSERT INTO `armaduras` VALUES (1,'Cota de Malha','16','27kg','75 PO',13,'desvantagem'),(2,'Escudo','+2','3kg','10 PO',NULL,NULL),(3,'Couro Batido','12+mod.Des','7kg','45 PO',NULL,NULL),(4,'Gibão de Pele','12+mod.Des(máx.2)','6kg','10 PO',NULL,NULL);
